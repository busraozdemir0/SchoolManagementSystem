...
{
    public class DashboardStudentLastSixReportViewComponent : ViewComponent
    {
        ...
        public DashboardStudentLastSixReportViewComponent(IMapper mapper, IUnitOfWork unitOfWork, ICommentService commentService, IHttpContextAccessor httpContextAccessor)
        {
            _mapper = mapper;
