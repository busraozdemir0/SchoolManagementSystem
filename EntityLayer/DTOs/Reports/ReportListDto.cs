...
namespace EntityLayer.DTOs.Reports
{
    public class ReportListDto
    {
        ...
        // Toplam kac sayfa olmasi gerektigini Toplam haber sayisini, bir sayfada olmasi gereken haber sayisina bolere buluyoruz.
        // Ceiling metodu her zaman yukari yuvarlar.

        public virtual bool ShowPrevious => CurrentPage > 1;  
        // Su an bulunan sayfa 1'den buyukse onceki butonu goster (ornegin 3. sayfada isek 1 ve 2 butonlarini gosterecek)
